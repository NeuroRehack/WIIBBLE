...
**Cursor Size**: Adjusts on-screen cursor size (10–100 px). For the circle this is the radius; for the avatar it sets the height to match the circle diameter. Size stays fixed when you zoom the canvas. You can also drag the cursor on-screen to resize it.
